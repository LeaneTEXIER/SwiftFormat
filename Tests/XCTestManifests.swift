...
extension ArgumentsTests {
    ...
    static let __allTests__ArgumentsTests = [
        ...
        ("testLintonlyMergeOptionsAdd", testLintonlyMergeOptionsAdd),
        ("testLintonlyMergeOptionsRemove", testLintonlyMergeOptionsRemove),
        ("testLintonlyRulesContain", testLintonlyRulesContain),
        ("testLintonlyRulesDontContain", testLintonlyRulesDontContain),
...
extension ParsingHelpersTests {
    ...
    static let __allTests__ParsingHelpersTests = [
        ...
        ("testClassOverrideDoesntCrashParseDeclarations", testClassOverrideDoesntCrashParseDeclarations),
        ...
        ("testDoCatchBracesNotTreatedAsClosure", testDoCatchBracesNotTreatedAsClosure),
        ...
        ("testGenericInitBracesNotTreatedAsClosure", testGenericInitBracesNotTreatedAsClosure),
        ("testGenericInitializerTrailingClosure", testGenericInitializerTrailingClosure),
        ("testGenericOptionalInitBracesNotTreatedAsClosure", testGenericOptionalInitBracesNotTreatedAsClosure),
        ...
        ("testProcessParametersInInit", testProcessParametersInInit),
...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testAddsMarkBeforeTypesWithNoBlankLineAfterMark", testAddsMarkBeforeTypesWithNoBlankLineAfterMark),
        ...
        ("testAddSpaceBetweenCaptureListAndArguments6", testAddSpaceBetweenCaptureListAndArguments6),
        ("testAddSpaceBetweenCaptureListAndArguments7", testAddSpaceBetweenCaptureListAndArguments7),
        ...
        ("testAddSpaceBetweenParenAndAwait", testAddSpaceBetweenParenAndAwait),
        ("testAddSpaceBetweenParenAndAwaitForSwift5_5", testAddSpaceBetweenParenAndAwaitForSwift5_5),
        ...
        ("testAddSpaceEvenAfterLHSArray", testAddSpaceEvenAfterLHSArray),
        ("testAddSpaceEvenAfterLHSClosure", testAddSpaceEvenAfterLHSClosure),
        ("testAddSpaceEvenAfterLHSParens", testAddSpaceEvenAfterLHSParens),
        ("testAddSpaceEvenBeforeRHSArray", testAddSpaceEvenBeforeRHSArray),
        ("testAddSpaceEvenBeforeRHSClosure", testAddSpaceEvenBeforeRHSClosure),
        ("testAddSpaceEvenBeforeRHSParens", testAddSpaceEvenBeforeRHSParens),
        ...
        ("testAssertionFailuresForPreconditionTrue", testAssertionFailuresForPreconditionTrue),
        ...
        ("testCaseOptionalNotReplaced2", testCaseOptionalNotReplaced2),
        ...
        ("testChainedClosureIndentsSeparatedByComments", testChainedClosureIndentsSeparatedByComments),
        ("testChainedFunctionInGuardIndentation", testChainedFunctionInGuardIndentation),
        ("testChainedFunctionInGuardIndentation2", testChainedFunctionInGuardIndentation2),
        ("testChainedFunctionInGuardWithXcodeIndentation", testChainedFunctionInGuardWithXcodeIndentation),
        ("testChainedFunctionInGuardWithXcodeIndentation2", testChainedFunctionInGuardWithXcodeIndentation2),
        ("testChainedFunctionOnNewLineWithXcodeIndentation", testChainedFunctionOnNewLineWithXcodeIndentation),
        ("testChainedFunctionOnNewLineWithXcodeIndentation2", testChainedFunctionOnNewLineWithXcodeIndentation2),
        ...
        ("testCommentNotRemovedInsideBracesWithSpacedConfiguration", testCommentNotRemovedInsideBracesWithSpacedConfiguration),
        ...
        ("testDoesntWrapReturnOnMultilineThrowingFunction", testDoesntWrapReturnOnMultilineThrowingFunction),
        ...
        ("testDoesntWrapReturnOnSingleLineFunctionDeclarationAfterMultilineMethodCall", testDoesntWrapReturnOnSingleLineFunctionDeclarationAfterMultilineMethodCall),
        ...
        ("testDoubleIndentTrailingClosureBody2", testDoubleIndentTrailingClosureBody2),
        ...
        ("testEmptyBracesLinebreakIndentedCorrectly", testEmptyBracesLinebreakIndentedCorrectly),
        ("testEmptyBracesLinebreakNotRemovedInIfElseWithLinebreakConfiguration", testEmptyBracesLinebreakNotRemovedInIfElseWithLinebreakConfiguration),
        ...
        ("testEmptyBracesSpaceNotRemovedInDoCatchWithSpacedConfiguration", testEmptyBracesSpaceNotRemovedInDoCatchWithSpacedConfiguration),
        ("testEmptyBracesSpaceNotRemovedInIfElseWithSpacedConfiguration", testEmptyBracesSpaceNotRemovedInIfElseWithSpacedConfiguration),
        ...
        ("testExplicitTypeInsertedForLiterals", testExplicitTypeInsertedForLiterals),
        ...
        ("testIfDefPostfixMemberSyntaxNoIndenting", testIfDefPostfixMemberSyntaxNoIndenting),
        ("testIfDefPostfixMemberSyntaxOutdenting", testIfDefPostfixMemberSyntaxOutdenting),
        ...
        ("testIndentIfDefPostfixMemberSyntax", testIndentIfDefPostfixMemberSyntax),
        ...
        ("testInsertBlankLinesJustBeforeMarkNotAfter", testInsertBlankLinesJustBeforeMarkNotAfter),
        ...
        ("testLinebreaksRemovedInsideBracesWithSpacedConfiguration", testLinebreaksRemovedInsideBracesWithSpacedConfiguration),
        ...
        ("testMeaningfulParensAroundClosureTypeNotRemoved", testMeaningfulParensAroundClosureTypeNotRemoved),
        ("testMeaningfulParensAroundPrefixExpressionFollowedByDotNotRemoved", testMeaningfulParensAroundPrefixExpressionFollowedByDotNotRemoved),
        ("testMeaningfulParensAroundPrefixExpressionFollowedByPostfixExpressionNotRemoved", testMeaningfulParensAroundPrefixExpressionFollowedByPostfixExpressionNotRemoved),
        ("testMeaningfulParensAroundPrefixExpressionFollowedBySubscriptNotRemoved", testMeaningfulParensAroundPrefixExpressionFollowedBySubscriptNotRemoved),
        ("testMeaningfulParensAroundPrefixExpressionWithSpacesFollowedByDotNotRemoved", testMeaningfulParensAroundPrefixExpressionWithSpacesFollowedByDotNotRemoved),
        ("testMeaningfulParensAroundTryExpressionNotRemoved", testMeaningfulParensAroundTryExpressionNotRemoved),
        ("testMeaningfulParensNotRemovedAroundFileLiteral", testMeaningfulParensNotRemovedAroundFileLiteral),
        ("testMeaningfulParensNotRemovedAroundOperator", testMeaningfulParensNotRemovedAroundOperator),
        ("testMeaningfulParensNotRemovedAroundOperatorWithSpaces", testMeaningfulParensNotRemovedAroundOperatorWithSpaces),
        ("testMeaningfulParensNotRemovedAroundPrefixOperator", testMeaningfulParensNotRemovedAroundPrefixOperator),
        ...
        ("testNoDeleteCommentWhenUnhoistingWrappedLet", testNoDeleteCommentWhenUnhoistingWrappedLet),
        ...
        ("testNoInsertBlankLineAfterMarkAtStartOfFile", testNoInsertBlankLineAfterMarkAtStartOfFile),
        ...
        ("testNoInsertExtraBlankLinesAroundMarkWithNoBlankLineAfterMark", testNoInsertExtraBlankLinesAroundMarkWithNoBlankLineAfterMark),
        ...
        ("testNoInsertSelfForVarDefinedInFor", testNoInsertSelfForVarDefinedInFor),
        ("testNoInsertSelfForVarDefinedInIfCaseLet", testNoInsertSelfForVarDefinedInIfCaseLet),
        ("testNoInsertSelfForVarDefinedInUnhoistedIfCaseLet", testNoInsertSelfForVarDefinedInUnhoistedIfCaseLet),
        ("testNoInsertSelfForVarDefinedInWhileLet", testNoInsertSelfForVarDefinedInWhileLet),
        ...
        ("testNoRemoveBackticksAroundActorProperty", testNoRemoveBackticksAroundActorProperty),
        ...
        ("testNoRemoveRedundantTypeIfVoid", testNoRemoveRedundantTypeIfVoid),
        ("testNoRemoveRedundantTypeIfVoid2", testNoRemoveRedundantTypeIfVoid2),
        ("testNoRemoveRedundantTypeIfVoid3", testNoRemoveRedundantTypeIfVoid3),
        ("testNoRemoveRedundantTypeIfVoid4", testNoRemoveRedundantTypeIfVoid4),
        ("testNoRemoveRedundantTypeIfVoid5", testNoRemoveRedundantTypeIfVoid5),
        ("testNoRemoveRedundantTypeIfVoid6", testNoRemoveRedundantTypeIfVoid6),
        ...
        ("testNoRemoveReturnInForWhereLoop", testNoRemoveReturnInForWhereLoop),
        ...
        ("testNoRemoveVoidReturnInCatch", testNoRemoveVoidReturnInCatch),
        ...
        ("testNoSpaceAfterPrefixOperator", testNoSpaceAfterPrefixOperator),
        ...
        ("testNoSpaceBeforePostfixOperator", testNoSpaceBeforePostfixOperator),
        ...
        ("testNoTrailingCommaAddedToArrayLiteralInsideTuple", testNoTrailingCommaAddedToArrayLiteralInsideTuple),
        ...
        ("testOptionalComposedProtocolWrappedInParensConvertedToSugar", testOptionalComposedProtocolWrappedInParensConvertedToSugar),
        ...
        ("testOptionalTupleWrappedInParensConvertedToSugar", testOptionalTupleWrappedInParensConvertedToSugar),
        ...
        ("testOrganizeClassDeclarationsIntoCategoriesWithNoBlankLineAfterMark", testOrganizeClassDeclarationsIntoCategoriesWithNoBlankLineAfterMark),
        ...
        ("testParensNotRemovedAroundRangeArgumentBeginningWithDot", testParensNotRemovedAroundRangeArgumentBeginningWithDot),
        ("testParensNotRemovedAroundRangeArgumentBeginningWithPrefixOperator", testParensNotRemovedAroundRangeArgumentBeginningWithPrefixOperator),
        ...
        ("testParensRemovedAroundRangeArgumentBeginningWithDot", testParensRemovedAroundRangeArgumentBeginningWithDot),
        ("testParensRemovedAroundRangeArgumentBeginningWithPrefixOperator", testParensRemovedAroundRangeArgumentBeginningWithPrefixOperator),
        ("testParensRemovedAroundRangeArguments", testParensRemovedAroundRangeArguments),
        ...
        ("testRedundantParensAroundClosureTypeRemoved", testRedundantParensAroundClosureTypeRemoved),
        ("testRedundantParensAroundInfixEqualsExpressionNotRemoved", testRedundantParensAroundInfixEqualsExpressionNotRemoved),
        ("testRedundantParensAroundInfixExpressionNotRemoved", testRedundantParensAroundInfixExpressionNotRemoved),
        ("testRedundantParensAroundIsNotRemoved", testRedundantParensAroundIsNotRemoved),
        ("testRedundantParensAroundNestedClosureTypesNotRemoved", testRedundantParensAroundNestedClosureTypesNotRemoved),
        ("testRedundantParensAroundPostfixExpressionFollowedByPostfixOperatorRemoved", testRedundantParensAroundPostfixExpressionFollowedByPostfixOperatorRemoved),
        ("testRedundantParensAroundPostfixExpressionFollowedBySubscriptRemoved", testRedundantParensAroundPostfixExpressionFollowedBySubscriptRemoved),
        ("testRedundantParensAroundPostfixExpressionRemoved", testRedundantParensAroundPostfixExpressionRemoved),
        ("testRedundantParensAroundPrefixExpressionRemoved", testRedundantParensAroundPrefixExpressionRemoved),
        ...
        ("testRedundantReturnInVoidFunction", testRedundantReturnInVoidFunction),
        ("testRedundantReturnInVoidFunction2", testRedundantReturnInVoidFunction2),
        ...
        ("testRedundantSelfInInitWithActorLabel", testRedundantSelfInInitWithActorLabel),
        ...
        ("testRedundantTypeDoesNothingGuardLet", testRedundantTypeDoesNothingGuardLet),
        ...
        ("testRedundantTypeIfVoid", testRedundantTypeIfVoid),
        ...
        ("testRemoveBackticksAroundActorLabel", testRemoveBackticksAroundActorLabel),
        ("testRemoveBackticksAroundActorLabel2", testRemoveBackticksAroundActorLabel2),
        ("testRemoveBackticksAroundActorRvalue", testRemoveBackticksAroundActorRvalue),
        ...
        ("testRemoveSpaceEvenAfterLHSArray", testRemoveSpaceEvenAfterLHSArray),
        ("testRemoveSpaceEvenAfterLHSClosure", testRemoveSpaceEvenAfterLHSClosure),
        ("testRemoveSpaceEvenAfterLHSParens", testRemoveSpaceEvenAfterLHSParens),
        ("testRemoveSpaceEvenBeforeRHSArray", testRemoveSpaceEvenBeforeRHSArray),
        ("testRemoveSpaceEvenBeforeRHSClosure", testRemoveSpaceEvenBeforeRHSClosure),
        ("testRemoveSpaceEvenBeforeRHSParens", testRemoveSpaceEvenBeforeRHSParens),
        ...
        ("testSpaceAddedInsideEmptyBracesWithSpacedConfiguration", testSpaceAddedInsideEmptyBracesWithSpacedConfiguration),
        ...
        ("testSpaceAfterSendableAttribute", testSpaceAfterSendableAttribute),
        ...
        ("testSpaceAroundGenericResultBuilder", testSpaceAroundGenericResultBuilder),
        ...
        ("testSwitchCaseOptionalNotReplaced", testSwitchCaseOptionalNotReplaced),
        ...
        ("testTodoNotReplacedAtEndOfDocBlock", testTodoNotReplacedAtEndOfDocBlock),
        ("testTodoNotReplacedAtStartOfDocBlock", testTodoNotReplacedAtStartOfDocBlock),
        ("testTodoNotReplacedInMiddleOfDocBlock", testTodoNotReplacedInMiddleOfDocBlock),
        ("testTodoReplacedInMiddleOfCommentBlock", testTodoReplacedInMiddleOfCommentBlock),
        ("testTrailingClosureOnRhsNotMangledInYodaCondition", testTrailingClosureOnRhsNotMangledInYodaCondition),
        ("testTrailingCommaAddedToArrayLiteralInsideTuple", testTrailingCommaAddedToArrayLiteralInsideTuple),
        ...
        ("testTrailingCommaNotAddedToSubscriptInsideArrayLiteral", testTrailingCommaNotAddedToSubscriptInsideArrayLiteral),
        ...
        ("testTrailingCommaNotAddedToTypeDeclaration4", testTrailingCommaNotAddedToTypeDeclaration4),
        ("testTrailingCommaNotAddedToTypeDeclaration5", testTrailingCommaNotAddedToTypeDeclaration5),
        ("testTrailingCommaNotAddedToTypeDeclaration6", testTrailingCommaNotAddedToTypeDeclaration6),
        ("testTrailingCommaNotAddedToTypeDeclaration7", testTrailingCommaNotAddedToTypeDeclaration7),
        ("testTrailingCommaNotAddedToTypeDeclaration8", testTrailingCommaNotAddedToTypeDeclaration8),
        ...
        ("testUppercaseAcronyms", testUppercaseAcronyms),
        ("testUppercaseCustomAcronym", testUppercaseCustomAcronym),
        ...
        ("testWrappedChainedFunctionsWithNestedScopeIndent", testWrappedChainedFunctionsWithNestedScopeIndent),
        ...
        ("testWrapPrivateSetVarAttributes", testWrapPrivateSetVarAttributes),
        ("testWrapPropertyWrapperAttribute", testWrapPropertyWrapperAttribute),
        ...
        ("testWrapReturnOnMultilineThrowingFunctionDeclarationWithAfterFirst", testWrapReturnOnMultilineThrowingFunctionDeclarationWithAfterFirst),
...
extension TokenizerTests {
    ...
    static let __allTests__TokenizerTests = [
        ("test_", test_),
        ("test_foo", test_foo),
        ("testActorLabel", testActorLabel),
        ("testActorProperty", testActorProperty),
        ("testActorProperty2", testActorProperty2),
        ("testActorProperty3", testActorProperty3),
        ("testActorType", testActorType),
        ("testActorVariable", testActorVariable),
        ...
        ("testNamespacedAttribute", testNamespacedAttribute),
